    ...
    return (
        <div className="max-w-7xl mx-auto px-3 py-8 text-gray-800 space-y-6">
            ...
            <p>
                ...
                <strong>Ubli</strong> respeitar a sua privacidade em relação a
            ...
            <p>
                ...
                perdas, roubos, acesso, divulgação, cópia, uso ou modificação
                não autorizados.
            </p>
            ...
            <ul className="list-disc list-inside space-y-2">
                <li>
                    ...
                    publicidade usa um cookie DoubleClick para exibir anúncios
                    mais relevantes e limitar o número de vezes que um anúncio é
                    exibido.
                </li>
                <li>
                    Para mais informações sobre o Google AdSense, consulte as
                    FAQs oficiais sobre privacidade do Google.
                </li>
                <li>
                    Utilizamos anúncios para compensar os custos de
                    funcionamento deste site e financiar desenvolvimentos
                    futuros. Os cookies de publicidade comportamental rastreiam
                    anonimamente seus interesses para exibir anúncios
                    relevantes.
                </li>
                <li>
                    Parceiros afiliados podem usar cookies para identificar
                    acessos ao site e garantir atribuição correta de comissões
                    ou promoções.
                </li>
            </ul>
            ...
            <p>
                ...
                informações que o Ubli oferece, incluindo mas não se limitando
                a:
            </p>

            <ul className="list-disc list-inside space-y-2">
                <li>
                    A) Não se envolver em atividades ilegais ou contrárias à boa
                    fé e à ordem pública;
                </li>
                <li>
                    B) Não difundir propaganda ou conteúdo racista, xenofóbico,
                    de azar, pornografia ilegal, apologia ao terrorismo ou que
                    viole direitos humanos;
                </li>
                <li>
                    C) Não causar danos aos sistemas do Ubli, seus fornecedores
                    ou terceiros, nem disseminar vírus ou softwares maliciosos.
                </li>
            </ul>
            ...
            <p>
                Esperamos que esteja esclarecido e, como mencionado, se houver
                algo que você não tenha certeza se precisa ou não, é mais seguro
                manter os cookies ativados caso utilize algum recurso que os
                necessite.
            </p>
