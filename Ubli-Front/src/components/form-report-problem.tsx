        ...
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <div className="bg-white py-8 px-4 shadow rounded-lg sm:px-10 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Seu problema foi registrado com sucesso. Nossa equipe entrará em
              contato em breve.
            </p>
            <button
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-gray-600">
            Preencha o formulário abaixo para nos informar sobre o problema
            encontrado.
          </p>
        </div>
              ...
              <div>
                ...
                <div className="mt-1">
                  ...
                  >
                    ...
                    <option value="content">Conteúdo Incorreto</option>
                    <option value="usability">Dificuldade de Uso</option>
        ...
        <div className="mt-6 text-center text-sm text-gray-500">
          <p>Nossa equipe entrará em contato em até 48 horas úteis.</p>
        </div>
      </div>
    </div>
  );
